 ...
 */
	virtual short GetCurrentAlarm(long &id,QString &msg) = 0;
 ...
 * @return		<1>: 读取失败
 */	
	virtual short LoadAlarmFromFile(QMultiMap<int,QString> &alarm_map) = 0;
 ...
 */	
	virtual short SaveAlarmToFile(QMultiMap<int,QString> &alarm_map) = 0;
